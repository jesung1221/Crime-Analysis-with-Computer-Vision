...
class Drawer:
    ...
    def render_frame(self, image, predictions, **user_text_kwargs):
        ...
        with open("../output/Output_trial.txt","a") as f:
            for pred in predictions:
                ...
                self.draw_trtpose(render_frame, pred, f)
    ...
    def draw_trtpose(self, image, pred, txtf):
        ...
        for kp in pred.keypoints:
            if kp[1]==0 or kp[2]==0:
                ...
                continue
            print (kp[0], file = txtf, end=' ')
            print (kp[1]/image.shape[1], file = txtf, end=' ')
            print (kp[2]/image.shape[0], file = txtf)
            if self.draw_points:
